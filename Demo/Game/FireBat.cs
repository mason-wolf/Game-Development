...
namespace Demo.Engine
{
    ...
    public class FireBat
    {
        ...
        {
            Texture = content.Load<Texture2D>(@"spritesheets\FireBat");
            Atlas = TextureAtlas.Create(Texture, 32, 32);
            Animation = new SpriteSheetAnimationFactory(Atlas);
            float animationSpeed = .2f;
            float attackSpeed = 0.2f;
            Animation.Add("idle", new SpriteSheetAnimationData(new[] { 0, 1, 2 }, animationSpeed, isLooping: true));
            ...
            Animation.Add("idleWest", new SpriteSheetAnimationData(new[] { 0, 1, 2 }));
            ...
            Animation.Add("idleEast", new SpriteSheetAnimationData(new[] { 0, 1, 2 }));
            ...
            Animation.Add("idleNorth", new SpriteSheetAnimationData(new[] { 0, 1, 2 }));
